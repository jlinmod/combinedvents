module ecosys_forcing_mod
  ...
  type(tracer_read)   :: docventflux_input              ! namelist input for docventflux source
  type(tracer_read)   :: docfluidy_input                ! namelist input for docfluidy sink
...
contains
  ...
  subroutine ecosys_forcing_init(ciso_on, land_mask,                     &
    ...
    namelist /ecosys_forcing_data_nml/                                        &
         ...
         docventflux_input, docfluidy_input,    &
